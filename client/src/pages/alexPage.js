  ...
  return (
    <>
      ...
      <form action="/alex" method="POST">
        ...
        <p>
          {/* 
          <b>Для стратегии 3.5: Сигнал № 1 (3 зеленых, 1 красная):</b>
          <br />*/}
          <b>Для стратегии 3.7: Сигнал № 1 (2 зеленых, 1 красная):</b>
        ...
        <p>
          {/* 
          <b>Для стратегии 3.5: сигнал №3</b> */}
          <br /> <b>Для стратегии 3.7: сигнал №4</b>
        ...
        <p>
          ...
          относительно Open Price сигнальной свечки
          <br />
          На двух примерах было вычислено: от 0.165 до 0.84. Ноль - коэффициент
          будет равень нулью.
        </p>
        <div class="input-field">
