...
const alNot3824Class2h = require('./alNot3824Class2h')
const { symbols2h3824, timeFrames, nameStrategy } = require('./symbols') // для удобного выноса общих переменных

async function al3824Not2h() {
  ...
  symbols2h3824.forEach(function (item, i, arg) {
    symbolObj[i] = new alNot3824Class2h(item, nameStrategy.notice2h3824)
  })
