...
function alexNoticeMain3824() {
  // запускаем 3.8.2.4 на 2h
  const al3824Not2h = require('./al3824Not2h')
  al3824Not2h()
  ...
  const message1 = `\n\n${nameStrategy.notice2h3824}\nНа ${
    symbols2h3824.length
...
module.exports = alexNoticeMain3824
