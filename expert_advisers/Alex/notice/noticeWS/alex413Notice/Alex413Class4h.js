    ...
    if (lastCandle.interval == interval) {
      ...
      if (
        ...
        if (!this.sygnalSent) {
          ...
          this.middleShadow =
            (this.candlesForFractal[7].open + this.candlesForFractal[7].high) /
            2 // середина верхней тени
      ...
      if (
        ...
        if (!this.sygnalSent) {
          ...
          this.openShort = this.candlesForFractal[7].high
          this.openShortCommon()
        }
