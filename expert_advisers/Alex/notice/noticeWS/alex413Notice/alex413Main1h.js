...
const Alex413Class1h = require('./Alex413Class1h')
const { symbols4h41, timeFrames } = require('./input_parameters413')
const { sendInfoToUser } = require('../../../../../API/telegram/telegram.bot')
const timestampToDateHuman = require('../../../../common.func/timestampToDateHuman')

// общий шаблон
async function alex413Main1h(
  timeFrameSenior,
  nameStrategy,
  takeProfitConst,
  stopLossConst,
  ...
  symbols4h41.forEach(function (item, i, arg) {
    symbolObj[i] = new Alex413Class1h(
      item,
      nameStrategy,
      takeProfitConst,
      stopLossConst,
