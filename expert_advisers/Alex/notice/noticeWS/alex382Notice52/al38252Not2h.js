...
const alNot38252Class2h = require('./alNot38252Class2h')
...
async function al38252Not2h() {
  ...
  symbols2h3825.forEach(function (item, i, arg) {
    symbolObj[i] = new alNot38252Class2h(item, nameStrategy.notice2h3825)
  })
        ...
        if (item.symbol.includes(lastCandle.symbol)) {
          ...
          if (item.inPosition) {
            if (!final) {
              ...
              item.changeSL(lastCandle, timeFrames.timeFrame1m)
