...
const An43Trade30m = require('./an43Trade30m')
// const { timeFrames } = require('./input_parameters')
const { sendInfoToUser } = require('../../../../../API/telegram/telegram.bot')
const timestampToDateHuman = require('../../../../common.func/timestampToDateHuman')

// общий шаблон
async function an43Logic30m(
  symbols4h41,
  timeFrameSenior,
  nameStrategy,
  takeProfitConst,
