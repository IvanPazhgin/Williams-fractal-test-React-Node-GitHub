...
const findSygnal38H = require('./findSignal38H')
...
async function notInPositionH(lastCandle, symbolObj, timeFrame) {
  ...
  */
  ...
  if (!symbolObj.inPosition && !symbolObj.canShort) {
    symbolObj = findSygnal38H(candlesObject, symbolObj)
  }
  /*
  if (!symbolObj.inPosition && !symbolObj.canShort) {
