...
class alNot3823Class30m {
  ...
  reset() {
    ...
    this.delta = 1.006 // вход на 0.6% выше хая сигнальной свечи
    ...
    for (let i = 3; i < array.length; i++) {
      if (!this.inPosition) {
        ...
        if (
          ...
          array[i].low > array[i - 1].open // лой 3й красной большое цены открытия 2й зеленой
  ...
  changeTPSL(lastCandle, interval) {
    if (lastCandle.interval == interval) {
      // перенос TP SL: после закрытия 3 свечи
...
module.exports = alNot3823Class30m
