// name: без теневая
// VERSION 3.10 HARD на основе 3.8 HARD
// входим по цене highPrice
const timestampToDateHuman = require('../../../common.func/timestampToDateHuman')

function alex310testH(
  array,
  depositTemp,
  partOfDeposit,
  multiplier,
  ...
  for (let i = 4; i < array.length; i++) {
    if (!inShortPosition) {
      ...
      if (
        ...
        shadow2g = array[i - 3].highPrice / array[i - 3].closePrice - 1 // процент роста верхней тени 2й зеленой свечи
        if (
          //diffShadow < 0.3
          ...
          // дополнительные условия от 28.08.2022
          array[i - 2].lowPrice > array[i - 4].openPrice && // лой 3й красной большое цены открытия 1й зеленой
