...
function alex311test2(
  ...
  const nameStrategy = 'Стратегия №3.11.2: Без теневая 4h'
  ...
  for (let i = 3; i < array.length; i++) {
    if (!inShortPosition) {
      ...
      if (
        ...
        body1g = array[i - 3].highPrice / array[i - 3].lowPrice
        body2g = array[i - 2].highPrice / array[i - 2].lowPrice
        if (
