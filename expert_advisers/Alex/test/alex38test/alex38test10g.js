...
function alex38test10g(
  ...
  let condition = false // проверка первого уровня условий: кол-во зеленых
  ...
  for (let i = 12; i < array.length; i++) {
    if (!inShortPosition) {
      // сигнал № 2: вариант №2 от 29.08.2022
      ...
      if (
        ...
        array[i - 2].openPrice > array[i - 2].closePrice && // 3 свеча красная
        array[i - 1].openPrice > array[i - 1].closePrice && // 4 свеча красная
        array[i - 1].lowPrice > array[i - 5].lowPrice // лой последней красной выше лоя первой зеленой
      ) {
        condition = true
        whitchSignal = '3 зеленых'
      }

      // 4 зеленых
      if (
        array[i - 6].closePrice > array[i - 6].openPrice && // 1 свеча зелёная
        array[i - 5].closePrice > array[i - 5].openPrice && // 1 свеча зелёная
        array[i - 4].closePrice > array[i - 4].openPrice && // 1 свеча зелёная
        array[i - 3].closePrice > array[i - 3].openPrice && // 2 свеча зелёная
        array[i - 2].volume > array[i - 3].volume && // объем 3й красной больше объёма 2й зеленой
        array[i - 2].openPrice > array[i - 2].closePrice && // 3 свеча красная
        array[i - 1].openPrice > array[i - 1].closePrice && // 4 свеча красная
        array[i - 1].lowPrice > array[i - 6].lowPrice // лой последней красной выше лоя первой зеленой
      ) {
        condition = true
        whitchSignal = '4 зеленых'
      }

      // 5 зеленых
      if (
        array[i - 7].closePrice > array[i - 7].openPrice && // 1 свеча зелёная
        array[i - 6].closePrice > array[i - 6].openPrice && // 1 свеча зелёная
        array[i - 5].closePrice > array[i - 5].openPrice && // 1 свеча зелёная
        array[i - 4].closePrice > array[i - 4].openPrice && // 1 свеча зелёная
        array[i - 3].closePrice > array[i - 3].openPrice && // 2 свеча зелёная
        ...
        array[i - 2].openPrice > array[i - 2].closePrice && // 3 свеча красная
        array[i - 1].openPrice > array[i - 1].closePrice && // 4 свеча красная
        array[i - 1].lowPrice > array[i - 7].lowPrice // лой последней красной выше лоя первой зеленой
      ) {
        condition = true
        whitchSignal = '5 зеленых'
      }

      // 6 зеленых
      if (
        array[i - 8].closePrice > array[i - 8].openPrice && // 1 свеча зелёная
        array[i - 7].closePrice > array[i - 7].openPrice && // 1 свеча зелёная
        array[i - 6].closePrice > array[i - 6].openPrice && // 1 свеча зелёная
        array[i - 5].closePrice > array[i - 5].openPrice && // 1 свеча зелёная
        array[i - 4].closePrice > array[i - 4].openPrice && // 1 свеча зелёная
        ...
        array[i - 2].openPrice > array[i - 2].closePrice && // 3 свеча красная
        array[i - 1].openPrice > array[i - 1].closePrice && // 4 свеча красная
        array[i - 1].lowPrice > array[i - 8].lowPrice // лой последней красной выше лоя первой зеленой
      ) {
        condition = true
        whitchSignal = '6 зеленых'
      }

      // 7 зеленых
      if (
        array[i - 9].closePrice > array[i - 9].openPrice && // 1 свеча зелёная
        array[i - 8].closePrice > array[i - 8].openPrice && // 1 свеча зелёная
        array[i - 7].closePrice > array[i - 7].openPrice && // 1 свеча зелёная
        array[i - 6].closePrice > array[i - 6].openPrice && // 1 свеча зелёная
        array[i - 5].closePrice > array[i - 5].openPrice && // 1 свеча зелёная
        ...
        array[i - 2].openPrice > array[i - 2].closePrice && // 3 свеча красная
        array[i - 1].openPrice > array[i - 1].closePrice && // 4 свеча красная
        array[i - 1].lowPrice > array[i - 9].lowPrice // лой последней красной выше лоя первой зеленой
      ) {
        condition = true
        whitchSignal = '7 зеленых'
      }

      // 8 зеленых
      if (
        array[i - 10].closePrice > array[i - 10].openPrice && // 1 свеча зелёная
        array[i - 9].closePrice > array[i - 9].openPrice && // 1 свеча зелёная
        array[i - 8].closePrice > array[i - 8].openPrice && // 1 свеча зелёная
        array[i - 7].closePrice > array[i - 7].openPrice && // 1 свеча зелёная
        array[i - 6].closePrice > array[i - 6].openPrice && // 1 свеча зелёная
        ...
        array[i - 2].openPrice > array[i - 2].closePrice && // 3 свеча красная
        array[i - 1].openPrice > array[i - 1].closePrice && // 4 свеча красная
        array[i - 1].lowPrice > array[i - 10].lowPrice // лой последней красной выше лоя первой зеленой
      ) {
        condition = true
        whitchSignal = '8 зеленых'
      }

      // 9 зеленых
      if (
        array[i - 11].closePrice > array[i - 11].openPrice && // 1 свеча зелёная
        array[i - 10].closePrice > array[i - 10].openPrice && // 1 свеча зелёная
        array[i - 9].closePrice > array[i - 9].openPrice && // 1 свеча зелёная
        array[i - 8].closePrice > array[i - 8].openPrice && // 1 свеча зелёная
        array[i - 7].closePrice > array[i - 7].openPrice && // 1 свеча зелёная
        ...
        array[i - 2].openPrice > array[i - 2].closePrice && // 3 свеча красная
        array[i - 1].openPrice > array[i - 1].closePrice && // 4 свеча красная
        array[i - 1].lowPrice > array[i - 11].lowPrice // лой последней красной выше лоя первой зеленой
      ) {
        condition = true
        whitchSignal = '9 зеленых'
      }

      // 10 зеленых
      if (
        array[i - 12].closePrice > array[i - 12].openPrice && // 1 свеча зелёная
        array[i - 11].closePrice > array[i - 11].openPrice && // 1 свеча зелёная
        array[i - 10].closePrice > array[i - 10].openPrice && // 1 свеча зелёная
        array[i - 9].closePrice > array[i - 9].openPrice && // 1 свеча зелёная
        array[i - 8].closePrice > array[i - 8].openPrice && // 1 свеча зелёная
        ...
        array[i - 2].openPrice > array[i - 2].closePrice && // 3 свеча красная
        array[i - 1].openPrice > array[i - 1].closePrice && // 4 свеча красная
        array[i - 1].lowPrice > array[i - 12].lowPrice // лой последней красной выше лоя первой зеленой
      ) {
        condition = true
        whitchSignal = '10 зеленых'
      }
